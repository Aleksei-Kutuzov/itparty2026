...
doc4 = DocApzParticipationPayload(
    organization_name="МБОУ СОШ №123",
    period=datetime.datetime.now(),
    class_name="11А",
    records=[
...
gen = DocGeneral(class_info=doc1,
                 profile_performance=doc2,
                 olympiad_participation=doc3,
                 apz_participation=doc4,
                 research_works=doc5,
                 additional_education=doc6,
